...
Three interactive views built with Streamlit + Plotly, querying PostgreSQL directly.

---

**Prediction Overview**
Real-time prediction volume, fraud probability distribution, and per-request latency over time.

![ModelWatch Dashboard](assets/dashboard_top.png)

---

**Drift Detection**
Per-feature KS statistic and PSI score compared against training baselines, with alert threshold lines.
...
**Drift Alerts**
Feature-level drift alerts sorted by KS statistic. Shows which features are drifting and by how much across the prediction window.
...
<i>Data Engineering Portfolio · Project 2 of 4</i>